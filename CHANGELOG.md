...
* add crafting node to the state graph ([6e25816](https://github.com/MarkRagg/GoT/commit/6e25816e9995cc237975ebc3ae5deb21d0ccc24e))
* add divide thought reasoning and prompt complexity ([4abfccb](https://github.com/MarkRagg/GoT/commit/4abfccb69fdecf4f0a112606fa39a461870bad3f))
* add gemini apis ([fb903fb](https://github.com/MarkRagg/GoT/commit/fb903fb6ef366e820232b2227786a531c03aea62))
* add parser in order to launch from terminal ([460ced9](https://github.com/MarkRagg/GoT/commit/460ced9ae1994ea7e8b96fd4dd7211483d06f78b))
* add Response format and feedback on llm backtracking ([c727aee](https://github.com/MarkRagg/GoT/commit/c727aeed4015fbbdbc9d82050f556e6168b51faf))
* add Response format and feedback on llm backtracking ([3f2f514](https://github.com/MarkRagg/GoT/commit/3f2f5148c20ed42bc0b34d57d536e7b08ca5025b))
* create function to run gpqa hf dataset ([50acaa5](https://github.com/MarkRagg/GoT/commit/50acaa5cf3f882ad8833eb32c1e513435ec0afde))
* implement first version of custom compiled graph  ([f825452](https://github.com/MarkRagg/GoT/commit/f82545260db2a57e536447a313401dfdd3c8af73))
* implement first version of custom compiled graph  ([8fa0f12](https://github.com/MarkRagg/GoT/commit/8fa0f12320943790c88096da97fe1e174eb8f682))
* implement gemini llms ([2272033](https://github.com/MarkRagg/GoT/commit/22720339d1f47ffb7efe320dda864220d08356b9))
* implement lm eval benchmark testing ([dde7504](https://github.com/MarkRagg/GoT/commit/dde75044aa8c8f9ba8cde53401611283cb8d585d))
* implement lm eval benchmark testing ([e711cee](https://github.com/MarkRagg/GoT/commit/e711cee972e613a45830f4953b7b8d492563220e))
* implement mermaid print for runtime graph ([2b23685](https://github.com/MarkRagg/GoT/commit/2b2368566b71a32328325b1ed9a7f4d3ee727da9))
* implement mermaid print for runtime graph ([05bb4a7](https://github.com/MarkRagg/GoT/commit/05bb4a79f5024f89db574c789db6419c49d035b7))
* implementing reasoning node ([ee5b32f](https://github.com/MarkRagg/GoT/commit/ee5b32f0693db3898fd9717867586abb394b462a))
* introduce lm eval test benchmark ([163c5bd](https://github.com/MarkRagg/GoT/commit/163c5bdac7a72641f282f4a6c279855dad04fb4c))
* LLM can use runtime crafted tools ([b6a3050](https://github.com/MarkRagg/GoT/commit/b6a305010ce7085c01343861fca6d0ef2aa40dc2))
* now LLM can create and dynamic add a tool ([2c5cbd4](https://github.com/MarkRagg/GoT/commit/2c5cbd40ad768da999da602e169210e4afcebfe6))
* TestNode now check the tools used ([eb167d2](https://github.com/MarkRagg/GoT/commit/eb167d25dde0b3974456274e49e6f4b8707145b5))
* TestNode now check the tools used ([f32a2ff](https://github.com/MarkRagg/GoT/commit/f32a2ffa5025b213c4bad5c384d30106a7561980))
* update python versions ([92a2e3f](https://github.com/MarkRagg/GoT/commit/92a2e3fae92f285455cfb362461f36abbabb4d09))
* update python versions ([8c71858](https://github.com/MarkRagg/GoT/commit/8c71858c6c8dda537c6f8b891db173d6e642a8e5))

### Bug Fixes

* clea graph in case of exception ([5be77bb](https://github.com/MarkRagg/GoT/commit/5be77bb0c7fe13ae0ed048c81bfed2ee8bc2b768))
* correct mypy errors ([2271d6e](https://github.com/MarkRagg/GoT/commit/2271d6e81db141e984f0dad6aca51fd9844b6585))
* correct mypy errors ([9216693](https://github.com/MarkRagg/GoT/commit/92166931fff9001cc3587835473587d0503643f3))
* fix args names ([a4ce18c](https://github.com/MarkRagg/GoT/commit/a4ce18c5f303522668c9a4572dd4301ee9b0578f))
* fix hendrycks parsing response and correct solution ([adbe91d](https://github.com/MarkRagg/GoT/commit/adbe91d31b47ca708e5dee2c1d79a1198a94ed49))
* fix json saving for ResultEval ([aa3f3bf](https://github.com/MarkRagg/GoT/commit/aa3f3bfeb68d0f4fcff49f43df99c8390c0a14e4))
* fix judge messages, added the first question ([12e4885](https://github.com/MarkRagg/GoT/commit/12e4885d9b7a8d7b94f4a6e04b14ca2b8e44c868))
* fix judge messages, added the first question ([4fb3050](https://github.com/MarkRagg/GoT/commit/4fb3050e7fafa0cc0073feec13fdda627d517581))
* fix little errors ([33beb53](https://github.com/MarkRagg/GoT/commit/33beb5375ff5d9ad1770eebf2aba1b80e82fc239))
* fix little errors ([7b7c943](https://github.com/MarkRagg/GoT/commit/7b7c943688a814d63790b6ec88343a325d2b170f))
* fix prompt for not raise exception ([b141e8a](https://github.com/MarkRagg/GoT/commit/b141e8a827b52c64c33402fd252fe9bf77d4ca72))
* id node now are correct ([cd17f09](https://github.com/MarkRagg/GoT/commit/cd17f09cabb53b8a9b41245385e66208c6914cc9))
* judge agent now return an object ([eea2ea1](https://github.com/MarkRagg/GoT/commit/eea2ea1f3073f99752c86b7b2500bd7a48ffed37))
* judge agent now return an object ([fad35d1](https://github.com/MarkRagg/GoT/commit/fad35d15ceabcb9c0b3f0037f7802c4cd204cabb))
* load env in the right place ([4bc3c6f](https://github.com/MarkRagg/GoT/commit/4bc3c6fe09467c147c05f7829c977632c9a80318))
* load env in the right place ([0e93f06](https://github.com/MarkRagg/GoT/commit/0e93f06a51ce671300eea50e5b6ff3c40313ab66))

### General maintenance

* add a node for mermaid graph ([77e9a63](https://github.com/MarkRagg/GoT/commit/77e9a63cf01f75ef19212935630e990d2b0bf629))
* add a node for mermaid graph ([1820825](https://github.com/MarkRagg/GoT/commit/1820825ac33b7aa4dc2af01b7c900d490212afc7))
* add boto3 for mlflow ([6fc3bfc](https://github.com/MarkRagg/GoT/commit/6fc3bfc1c9bcf20fe75feb788803f3e9e4a73b39))
* add boto3 for mlflow ([4befe10](https://github.com/MarkRagg/GoT/commit/4befe106f66df3d7aaed2bc5cf25105f31d2b95f))
* add clear of runtime graph ([d15782c](https://github.com/MarkRagg/GoT/commit/d15782c5dd45e5219109ae89ceca163e589c6501))
* add clear of runtime graph ([09451d9](https://github.com/MarkRagg/GoT/commit/09451d98ce23c715231a25b99ae71791fe4a7a4c))
* add description on tools ([efcc206](https://github.com/MarkRagg/GoT/commit/efcc206d477b3ca5a07f47ed25042a14083eaf7f))
* add description on tools ([8852fbc](https://github.com/MarkRagg/GoT/commit/8852fbc3e5f35e2d062c9453f0fb688ddcd07ef6))
* add division and removing useless sum tools ([d066977](https://github.com/MarkRagg/GoT/commit/d06697767d92a31ba906de35676eaa12a258857d))
* add filter in print ([444eaec](https://github.com/MarkRagg/GoT/commit/444eaecf8928064ab0f9b7644fb369a698ab4a62))
* add filter on benchmark print ([318f42a](https://github.com/MarkRagg/GoT/commit/318f42adf97ea581b30550463388741d03d84232))
* add hendrycks math ([bbffc72](https://github.com/MarkRagg/GoT/commit/bbffc72934265faeb0f3e80ad074dbb960639afe))
* add libraries ([db0706f](https://github.com/MarkRagg/GoT/commit/db0706ff638b69494a880043107b1672f2680d08))
* add libraries ([a9bf853](https://github.com/MarkRagg/GoT/commit/a9bf8534c9b8d9ea94176271d8511d095f54e850))
* add lm eval math ([f1ec74f](https://github.com/MarkRagg/GoT/commit/f1ec74f73fc7208130d95890e7083019730cfc60))
* add lm-eval ([ccdc176](https://github.com/MarkRagg/GoT/commit/ccdc176d35bd1b6f5d4677edb98d7c717de4a2a2))
* add lm-eval ([8856bee](https://github.com/MarkRagg/GoT/commit/8856bee61020802296db7ff0bdb8f71cca004ba5))
* add more control on crafting ([24ce2a7](https://github.com/MarkRagg/GoT/commit/24ce2a73dde6cd752b193ce0671385a39b4a9ba9))
* add multiply ([6d5d211](https://github.com/MarkRagg/GoT/commit/6d5d2119c3caffc8fa679b3727b0bca89dc79743))
* add multiply ([07f31eb](https://github.com/MarkRagg/GoT/commit/07f31ebc54d961542286374836e46a3ae75adc89))
* add normalize number ([73f9d31](https://github.com/MarkRagg/GoT/commit/73f9d31d27b3c31f9ed7f21fdf5d0ff65f7efb67))
* add print function for bench testing ([8135df1](https://github.com/MarkRagg/GoT/commit/8135df1c26dd4806be266154ccbaf6dd7500eb03))
* add reset of Runtime id ([17bfacc](https://github.com/MarkRagg/GoT/commit/17bfaccfc4eb5de4aa3182a451fa7bf1956a5c84))
* add Score BaseModel ([fbe0760](https://github.com/MarkRagg/GoT/commit/fbe076011cc20fedc23ba2e41271a382be959b45))
* add Score BaseModel ([4dc9660](https://github.com/MarkRagg/GoT/commit/4dc96602b7c929b9182b7cff4301eec90a3eef91))
* add score threshold ([4b1bdd5](https://github.com/MarkRagg/GoT/commit/4b1bdd5a34c3fd43263f5ba9789e433857a97950))
* add use_benchmark ([fe84c94](https://github.com/MarkRagg/GoT/commit/fe84c94a5a950efc01c08614ed5d929d11157513))
* add util methods ([24fb15c](https://github.com/MarkRagg/GoT/commit/24fb15c61077f763612e18712ecf51b92a7a8563))
* add util methods ([9ee5193](https://github.com/MarkRagg/GoT/commit/9ee51934c7f80682548efb552cd2b18b67655f72))
* change init for parse args ([3492209](https://github.com/MarkRagg/GoT/commit/3492209a3127756c4d9643a815ac61ff5ea08e96))
* change method of graph call ([beba81c](https://github.com/MarkRagg/GoT/commit/beba81c8a934041c749a2f9b93276e9f67990c3f))
* change temperature for formatted output ([e85ebde](https://github.com/MarkRagg/GoT/commit/e85ebde2d8f5e079d7ff70e77016d9b6b4bbcb66))
* comment unused line ([55edd84](https://github.com/MarkRagg/GoT/commit/55edd8470346ce679e9408047eb0f959df99fe7d))
* control syntax of crafted functions ([bba6cea](https://github.com/MarkRagg/GoT/commit/bba6cea8ac58ede402f39c7c7be888efd8065cbd))
* create model folder ([e3656bd](https://github.com/MarkRagg/GoT/commit/e3656bde405c0fe58ac9436e6d7f16c064f20379))
* create model folder ([5454477](https://github.com/MarkRagg/GoT/commit/545447744678f914c2a777f452c7a0d28453f329))
* create two function for benchmark or custom test ([ca4c0d8](https://github.com/MarkRagg/GoT/commit/ca4c0d8c201667b76928595139466dea1742a2e5))
* create two function for benchmark or custom test ([9404a98](https://github.com/MarkRagg/GoT/commit/9404a98956db8e4bf38212e4fb586408084b61c6))
* extract output also for gemini ([45ffef0](https://github.com/MarkRagg/GoT/commit/45ffef063d1af5ce9f5ce0804ead89dd9059c9b6))
* fix  node bugs ([981a8a2](https://github.com/MarkRagg/GoT/commit/981a8a28aaa2890de195d9b790da5d5d87cbbf7b))
* fix benchmark test ([ad7bfe7](https://github.com/MarkRagg/GoT/commit/ad7bfe78b287f27bce19da0e8937f88cb5e17999))
* fix for mypy ([bdbf353](https://github.com/MarkRagg/GoT/commit/bdbf3531226f9de46a24f18fcf1eb1ec31760e5b))
* fix for mypy ([9eee32d](https://github.com/MarkRagg/GoT/commit/9eee32d18e705851a844249cbd5e0b989581997c))
* fix mypy ([0a90482](https://github.com/MarkRagg/GoT/commit/0a904825d912c53d0eb79c19e4b1169742f3ffcc))
* fix mypy ([b8dde84](https://github.com/MarkRagg/GoT/commit/b8dde84c5534305c33d669382fab85d415136d84))
* force output format on node ([8bd1077](https://github.com/MarkRagg/GoT/commit/8bd107735e18e19e8b3fd31ee7e73b739bfcbcab))
* implement crafting tools ([7796d64](https://github.com/MarkRagg/GoT/commit/7796d64256f69f6867847b29b391e54aaca3aa75))
* improve agent prompts ([4be202b](https://github.com/MarkRagg/GoT/commit/4be202b49a73d090d3acdba7c4ee2c768f4dbd4c))
* improve and refine runtime graph ([e08d2a3](https://github.com/MarkRagg/GoT/commit/e08d2a37a205bfc5bde7565e815788e63814f4b7))
* improve and refine runtime graph ([845d442](https://github.com/MarkRagg/GoT/commit/845d4429f7f6c6041954a7c341059be870ac2f29))
* improve compiled graph ([f142755](https://github.com/MarkRagg/GoT/commit/f1427551402b47eb2cab58e884a2bece2c408bb6))
* improve compiled graph ([9ee7f94](https://github.com/MarkRagg/GoT/commit/9ee7f9425a1d65bcb4f7b139ef2f417854de0434))
* improve evaluation ([637d454](https://github.com/MarkRagg/GoT/commit/637d454a28e8f9fcb809b6f527b77fc1df287c28))
* improve math tools ([ed00256](https://github.com/MarkRagg/GoT/commit/ed002560eab6c8a10f9466896473b8ebe174aac9))
* improve prompt ([ec7f8f5](https://github.com/MarkRagg/GoT/commit/ec7f8f50fa129295839a3975b993efbe64fb13e9))
* improve prompt ([bfcc707](https://github.com/MarkRagg/GoT/commit/bfcc70754875bb150fcf22b1e4635645a5d2dd7f))
* improve prompt and models ([637ba71](https://github.com/MarkRagg/GoT/commit/637ba71e3ddd3f3da2078b0fb2bee681db07add8))
* improve response format ([7efc991](https://github.com/MarkRagg/GoT/commit/7efc991f5d88681701fb1df85a7e4059c4681145))
* initialise repository renaming files and removing init workflow [skip ci] ([8f9e0c8](https://github.com/MarkRagg/GoT/commit/8f9e0c8fb2b73641a7130c69915fe6973475b797))
* parsing output to filter correctly the response ([014b1f9](https://github.com/MarkRagg/GoT/commit/014b1f94567efd0d88101353caa5574923a4aa97))
* print loglikehood benchmark ([131ad0a](https://github.com/MarkRagg/GoT/commit/131ad0a219162ac02bcad53b7eda732b5dbfa52f))
* remove warning ([11c572c](https://github.com/MarkRagg/GoT/commit/11c572cd150eb9fd7c8d21081e0de8d8bfc95f92))
* removing reasoning and add remote llm ([1b2602a](https://github.com/MarkRagg/GoT/commit/1b2602a5f05e67f94ad6fb497644e6673c0ba8bf))
* resolve mypy problems ([d51bdc9](https://github.com/MarkRagg/GoT/commit/d51bdc9c3f3e0d410c643e0bbabb894ed894e1f7))
* resolve mypy problems ([433277b](https://github.com/MarkRagg/GoT/commit/433277b21c7d88a8795c6d0817ad39e8e9602a46))
* save tool in files ([038954b](https://github.com/MarkRagg/GoT/commit/038954b5b4b54f9e42229c7f2a32267365ad87b4))
* temporarly suspend pypi publication ([7ed7da3](https://github.com/MarkRagg/GoT/commit/7ed7da32e86d4c9c1cdaab400b855874167059af))
* tests goes on also if one test raise an exception ([20f7cc1](https://github.com/MarkRagg/GoT/commit/20f7cc18ee140a3f8f5be0899e286542879b64c8))
* uncomment logger ([2faa227](https://github.com/MarkRagg/GoT/commit/2faa22752bf1fc947a279cdcc3b11c16421a2d01))
* update gitignore ([4c88edd](https://github.com/MarkRagg/GoT/commit/4c88edddf2e28c2be3560b2afe77fb76ce4a4de0))
* use gpqa diamond as benchmark ([3b492e8](https://github.com/MarkRagg/GoT/commit/3b492e81d8085c1957117bed61f3cb489e590b71))

### Style improvements

* poe format ([e729552](https://github.com/MarkRagg/GoT/commit/e729552c37484e6a1ff036b94f81362cdb6a8d86))
* ruff format ([22a423e](https://github.com/MarkRagg/GoT/commit/22a423e61f4392f9c3e50882398449d1d17f2fa0))
* ruff format ([ce7a1aa](https://github.com/MarkRagg/GoT/commit/ce7a1aae8a141fff8daf5ecf4137422c07859572))
* ruff format ([26b1824](https://github.com/MarkRagg/GoT/commit/26b1824f80df51db261d78d055ee060601c0ff88))
* ruff format ([a2c8894](https://github.com/MarkRagg/GoT/commit/a2c8894a5b5fc10b6a95940601f67a5eeb75cf2e))
* ruff format ([ea4b665](https://github.com/MarkRagg/GoT/commit/ea4b665cb88a4a2e413ed4a870fa426b3c1ab122))
* ruff format ([33441ad](https://github.com/MarkRagg/GoT/commit/33441adca748c6101eee6cf5612e3d609298b5cc))
* ruff format ([9a1f50f](https://github.com/MarkRagg/GoT/commit/9a1f50f12d09ca331e539756cf55a1811182c4e5))
* ruff format ([8057bf2](https://github.com/MarkRagg/GoT/commit/8057bf249f38f3a50872c43bed010430b3ac5fb1))
* ruff format ([748dd67](https://github.com/MarkRagg/GoT/commit/748dd67027b105e0f69f1c30113b7d39c139db83))
* ruff format ([407de96](https://github.com/MarkRagg/GoT/commit/407de961c001a16462eb8f64085e9495bafc05b3))
* ruff format ([36d7570](https://github.com/MarkRagg/GoT/commit/36d7570d13e731805b3f4591f4bc0db01049bf39))
* ruff format ([a26cf5c](https://github.com/MarkRagg/GoT/commit/a26cf5cd96939b811659029186d60d5f07ef24b9))
...
* move GoT folder upon renaming ([dcba4ab](https://github.com/aequitas-aod/template-python-project-poetry/commit/dcba4ab25a0a0c619ee8afacad9ff01a6f5bcfd6))
